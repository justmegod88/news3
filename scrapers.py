...
ETC_HINTS = [
    ...
    "장길현","더블어민주당","고성군의원","세미콘 코리아","반도체","원자력","강진군","한우","무역","이천시립기록원","디자이너","고향","유영규","스마트폰","지수","주가",
    "비보","메타렌즈","다이슨","관세","트럼프","민주당","중간선거","감독","스티브 쿠퍼","사노피","독감","백신","벤츠","아우디", "폭스바겐","사령관","대통령","LG화학", "롯데케미칼", "SK케미칼" 
]
